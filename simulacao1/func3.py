...
def getKeys (chave_pvt, chave_pub):
    global PIONEIRO_PUB, PIONEIRO_PVT
    PIONEIRO_PUB = chave_pub
    PIONEIRO_PVT = chave_pvt
...
def likeHosts (canal, hash_post):
    global PIONEIRO_PVT, PORTA
    subprocess.run(["./freechains", "chain", f"{canal}", f"--port={PORTA}", "like", hash_post, f"--sign={PIONEIRO_PVT}"], stdout=subprocess.PIPE, text=True)
